...
class RabbitMQAPI(object):
    ...
    def __init__(self, user_name='admin', password='admin123', host_name='',
                 protocol='http', port=15672, conf='/etc/zabbix/zabbix_agentd.d/rabbitmq_status.conf', senderhostname=None):
        self.user_name = user_name
        self.password = password
        self.host_name = host_name or socket.gethostname()
        self.protocol = protocol
        self.port = port
        self.conf = conf or '/etc/zabbix/zabbix_agentd.d/rabbitmq_status.conf'
...
def main():
    ...
    parser.add_option('--conf', default='/etc/zabbix/zabbix_agentd.d/rabbitmq_status.conf')
